...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			// is below.
			"xenorchestra_cloud_config": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getCloudConfig")},
			"xenorchestra_host":         {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getHost")},
			"xenorchestra_hosts":        {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getHosts")},
			"xenorchestra_network":      {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getNetwork")},
			...
			"xenorchestra_vms":          {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVms")},
		},
